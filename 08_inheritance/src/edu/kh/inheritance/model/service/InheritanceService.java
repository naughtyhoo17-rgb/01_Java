...
public class InheritanceService {
	...
	public void ex2() {
		...
		std.move(); // 오버라이딩 x -> Person(부모)의 메서드 그대로 수행
	...
	public void ex3() {
		...
		System.out.println(p.toString());
		/* print 구문 수행 시 참조변수명만 작성해도 자동으로
		 toString() 메서드 호출 -> Person에서 toString() 정의해둔 대로 출력 */
		
		Student std =  new Student("강호동", 18, "미국", 2, 6);
		System.out.println(std.toString()); // Person의 toString()을 참조하므로 거기서 정의한대로 출력
