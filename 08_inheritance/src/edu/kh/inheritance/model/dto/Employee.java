 ...
 * Object
 * 		ㄴ Person
 * 				ㄴ Employee / Student // 이 둘끼린 부모만 같을 뿐 아무 연관 x
 */

// final 클래스 : 상속불가 -> 누군가의 부모가 될 수 없다 (자식은 가능)
public /*final*/ class Employee extends Person {
	...
	public Employee(String name, int age, String nationality, String company) {
		super(name, age, nationality); // Person의 매개변수 생성자(Person에 매성이 있으니까 사용 가능한 것)
