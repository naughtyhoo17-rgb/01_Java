...
public class ClsService /* extends Student */{
	...
	public void ex2() {
		...
		-> 제대로 작성을 안해서, but 코드가 돌아가긴 해서 출력도 됨 */
		
		/* static이 붙은 변수(필드)/메서드는 '클래스명.변수명'으로 사용 */
	...
	public void ex3() {
		...
		User u1 = new User();
		/* 기본생성자를 개발자가 직접 만들지 않은 경우
		 컴파일러가 자동으로 기본생성자를 만들어 줌. */
		...
		/* 문제점 : u1이 참조하고 있는 User 객체와 u2가 참조하고 있는
		  User 객체의 필드값이 모두 동일함
		  -> why? 같은 기본생성자로 User 객체를 생성하고 있기 때문에
		  기본생성자에 작성된 코드가 똑같이 수행됨.. */
		
		System.out.println("-----------------------------------");
		
		// 해결방법 1 : setter를 이용해서 새로운 값 재대입 가능 
		...
		/* 해결방법 2 : 매개변수 생성자를 이용해 객체가 
		 생성될 때부터 다른값으로 필드를 초기화	*/
	...
	public void ex4() {
		...
		User u3 = new User("user03", "pass03", "이순신", 800, '남');
						// 매개변수 5개 생성자 전부 초기화	
