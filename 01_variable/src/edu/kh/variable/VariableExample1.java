...
public class VariableExample1 {
	...
	public static void main(String[] args) {
		...
		// 변수 사용 예시
		// 변수를 선언한다 = 상자(저장공간)를 만든다
		double pi = 3.141592653589793; // pi 라는 변수 선언 후 원주율 값 대입
		int r = 5; // r 이라는 변수 선언 후 반지름 값 대입
		int h = 20; // h 라는 변수 선언 후 높이 값 대입
