...
public class PrintExample {
	...
	System.out.println(); // 내용이 없는 println() : 단순 줄바꿈 역할
	...
	// System.out.printf("패턴" , 패턴자리에 각각 들어갈 값/변수 갯수만큼 나열)
	/* 
	 *  %d : 정수형
	 *  %f : 실수형
	 *  %c : 문자, %s : 문자열
	...
	// \t : tab (한 공간 씩 표현x, 한번에 공간차지)
	System.out.println("a\tb\tc\td");
	
	// 유니코드 이스케이프
	System.out.println("\u0041");
	// 65를 16진수로 표현
	// 65 / 16 해서 몫이 4, 나머지 1. 앞에 00붙이고 4랑1
